...
public class ShadowTests {
    ...
    //Move shadow of triangle little up
    @Test
    public void SphereTriangleMoveUp1() {
        ...
        Render render = new Render().
                setImageWriter(new ImageWriter("shadowSphereTriangleMoveUp1", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
    ...
    //TC03: move shadow of triangle a lot up
    @Test
    public void SphereTriangleMoveUp2() {
        scene = new Scene("Test scene");
        scene.geometries.add( //
                new Sphere(60, new Point3D(0, 0, -200)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereTriangleMoveUp2", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
    ...
    public void sphereTriangleMoveLight1() {
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereMoveLight1", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
    ...
    public void sphereTriangleMoveLight2() {
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereMoveLight2", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
