...
// *
// */
//public class BoundingBox implements Intersectable, Boundable {
//    /**
...
//     */
//    public static BoundingBox createTree(List<Boundable> boundables) {
//
...
//            ArrayList<BoundingBox> boxes = new ArrayList<>(boundables.stream().map(Boundable::getBoundingBox).collect(Collectors.toList()));
...
//     * @return AABB tree
//     */
//    private static BoundingBox createTreeRec(ArrayList<BoundingBox> boxes) {
//        //create a box that encapsulates all the other ones
//        BoundingBox node = new BoundingBox(boxes);
//
...
//        else {
//            ArrayList<BoundingBox> left, right;
//
...
//     */
//    public static void sortBoxesByAxis(ArrayList<BoundingBox> boxes, int axis) {
//        switch (axis) {
//            case 0:
//                boxes.sort((BoundingBox x, BoundingBox y) -> Double.compare(y.midX, x.midX));
//            case 1:
//                boxes.sort((BoundingBox x, BoundingBox y) -> Double.compare(y.midY, x.midY));
//            case 2:
//                boxes.sort((BoundingBox x, BoundingBox y) -> Double.compare(y.midZ, x.midZ));
//        }
//    }
//
//    /**
...
//            else {
//                res.addAll(((BoundingBox) item).getAllGeometries());
//            }
//        }
//
//        return res;
